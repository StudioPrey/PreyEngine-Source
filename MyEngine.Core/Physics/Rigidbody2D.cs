...
public sealed class Rigidbody2D : Component
{
    ...
    public override void OnAddedToScene() => Owner.Scene!.Physics.RegisterBody(this);

    public override void OnRemovedFromScene() => Owner.Scene!.Physics.UnregisterBody(this);
}
